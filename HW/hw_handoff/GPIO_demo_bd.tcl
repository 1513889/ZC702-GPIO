...
################################################################
# This is a generated script based on design: GPIO_demo
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.GPIO2_BOARD_INTERFACE {gpio_sw} CONFIG.GPIO_BOARD_INTERFACE {leds_4bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports gpio_sw] [get_bd_intf_pins axi_gpio_0/GPIO2]
